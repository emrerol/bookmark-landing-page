...
export default function Features() {
  ...
  return (
    <section className="featuresdiv">
      <h1>Features</h1>
      <p>
        {" "}
        Our aim is to make it quick and easy you to access your favourite
      ...
      <div className="buttonsdiv">
        ...
        <button className="button" id="easy" onClick={clickHandle} name="easy">
          Easy Sharing
        </button>
      </div>
      ...
      {tab.tab1 && (
        <div className="tabdiv">
          <img
            className="tabsillustration"
            src={Tab1}
            alt="illustration_tablet"
          ></img>
